...
export default class SearchableDropDown extends Component {
    ...
    renderScrollView = () => {
        if (this.state.focus) {
            const scrollViewProps = { ...this.props.listProps };
            ...
            defaultSupport.forEach((kv) => {
                if (!Object.keys(scrollViewProps).includes(kv.key)) {
                    scrollViewProps[kv.key] = kv.val;
                } else {
                    if (kv.key === 'style') {
                        scrollViewProps['style'] = kv.val;
                    }
                }
            });
